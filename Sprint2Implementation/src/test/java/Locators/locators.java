...
public class locators extends Browser {
	...
	public static WebElement testcase102() {
		WebElement clicklogin =driver.findElement(By.xpath("/html/body/div[4]/div[1]/div[4]/div[2]/div/div[2]/div[1]/div[2]/div[2]/form/div[5]/input"));
		return clicklogin;
	}
